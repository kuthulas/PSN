function kmrn()
% Generate sample time-series signal, a sinusoid
t = (0:0.01:1500)';
signal = 10*(1+cos(2*pi/500*t));
...
post=ceil([N*rand(Ne,M);Ne*rand(Ni,M)]); % make random connections
...
% DA-STDP
T=12*3600;      % the duration of experiment
...
for sec=1:T                             % simulation of 12 hours
